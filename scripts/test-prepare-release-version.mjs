...
if(before!==after||report.mode!=='dry-run'||report.currentVersion!==current||report.targetVersion!==target||report.pythonNormalizedTarget!==(target==='1.0.0-rc.1'?'1.0.0rc1':'1.0.0rc2')||report.files.length!==10||report.occurrences!==18)throw new Error('Release version dry-run contract failed');
