...
if(before!==after||report.mode!=='dry-run'||report.currentVersion!=='0.54.0'||report.targetVersion!=='1.0.0-rc.1'||report.pythonNormalizedTarget!=='1.0.0rc1'||report.files.length!==10||report.occurrences!==14)throw new Error('Release version dry-run contract failed');
