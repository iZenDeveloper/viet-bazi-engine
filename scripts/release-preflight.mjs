...
for(const path of ['dist/index.js','dist/index.d.ts','dist/mcp-server.js','dist/mcp.js','dist/wasm/calendar.wasm','schemas/manifest.json','schemas/interpretation-prompt-bundle-1.0.json','fixtures/v1/manifest.json','fixtures/v1/jie-multi-year.json','fixtures/v1/jpl-lichun-multi-century.json','fixtures/v1/timezone-boundaries.json','docs/ai-integration.md','docs/mcp.md','README.md','CHANGELOG.md','LICENSE'])if(!paths.has(path))throw new Error(`npm tarball missing ${path}`);
