...
test("calculates, localizes, compares and exports structured data", async ({
  page,
}) => {
  ...
  await expect(page.locator("#status")).toHaveText(
    "Calculation completed entirely offline.",
  );
  await expect(page.locator("html")).toHaveAttribute("lang", "en");
  await expect(page.locator('#facts li[data-code="DAY_MASTER"]')).toContainText(
    "Day Master",
  );
