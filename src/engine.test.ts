...
import { calculateBaziBatch,calculateBaziBatchFromJson,calculateBaziFromJson,validateBirthInput } from './json.js';
...
describe('calculateBazi',()=>{
  it('is deterministic and returns four known pillars for a Jia-Zi reference day',()=>{
    ...
    expect(a.metadata.methodology).toMatchObject({engineVersion:'0.21.0',profileCode:'VIET_BAZI_STANDARD_V1',calendar:{dayBoundary:'EARLY_ZI'}});
