...
> Trạng thái: `0.22.0` — API đang ở giai đoạn pre-1.0. Không dùng kết quả làm cơ sở duy nhất cho quyết định y tế, pháp lý hoặc tài chính.
...
Suite hiện có 62 test TypeScript, 7 test Python, kiểm thử CLI end-to-end, parity WASM và conformance runner. Bộ fixtures gồm 12 ranh Tiết năm 2026 và 6 ngày Can–Chi 1900–2099 từ NAOJ; sai số ranh Tiết quan sát lớn nhất là 11 phút với ngưỡng regression 15 phút.
