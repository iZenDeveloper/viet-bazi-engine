...
> Trạng thái: `0.44.0` — API đang ở giai đoạn pre-1.0. Không dùng kết quả làm cơ sở duy nhất cho quyết định y tế, pháp lý hoặc tài chính.
...
Suite bao phủ TypeScript, Python wheel cô lập, CLI end-to-end, demo/PWA, parity WASM full-output, JSON Schema và conformance runner. README không ghi tổng test thủ công; CI là nguồn trạng thái chính xác. Bộ fixtures gồm 12 ranh Tiết năm 2026 và 6 ngày Can–Chi 1900–2099 từ NAOJ; sai số ranh Tiết quan sát lớn nhất là 11 phút với ngưỡng regression 15 phút.
