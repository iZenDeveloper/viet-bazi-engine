...
Trình duyệt thực hiện toàn bộ calculation, True Solar Time và SVG rendering tại chỗ. Demo dùng catalog thành phố của engine, hỗ trợ hai quy ước đổi ngày và báo cáo Việt/Anh. Có thể tải kết quả dạng SVG/JSON hoặc methodology JSON đúng schema; input gần ranh Tiết khí sẽ hiện cảnh báo.
...
Phần compatibility dùng lá số đang hiển thị làm người A và nhận ngày giờ, giới tính, UTC offset, thành phố và True Solar Time riêng cho người B. Hai người chỉ dùng chung `asOfYear` và quy ước đổi ngày. Demo hiển thị tổng điểm, grade, bốn factor cùng evidence và disclaimer; kết quả tải xuống tuân theo `compatibility-result-1.0`.
