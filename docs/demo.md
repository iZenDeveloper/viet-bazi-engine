...
Mở `http://localhost:8080/demo/`. Trình duyệt thực hiện toàn bộ calculation, True Solar Time và SVG rendering tại chỗ. Có thể tải kết quả dạng SVG/JSON; input gần ranh Tiết khí sẽ hiện cảnh báo.
