...
Audit trace đóng mặc định để giữ giao diện gọn; khi mở, nó hiển thị engine/chart version, rule code/version/category và các đường dẫn input/output. Báo cáo tải xuống tuân theo `bazi-audit-report-1.0`.
