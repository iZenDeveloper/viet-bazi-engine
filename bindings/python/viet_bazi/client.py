...
class BirthInput:
    ...
    solarTermModel: Literal["legacy", "apparent", "ephemeris"] = "ephemeris"
    ...
    def to_payload(self) -> dict[str, Any]:
        ...
        if self.solarTermModel == "ephemeris":
...
def localize_chart_summary(value: BirthInput, *, locale: Literal["vi", "en"] = "vi") -> dict[str, Any]:
    command = [*_command(), "--compact", "--summary", "--locale", locale, "--stdin"]
    ...
    try:
        ...
        raise VietBaziError("Engine không trả JSON localized chart summary hợp lệ") from error
    return result
