...
export function getMethodologyManifest(dayBoundary, trueSolarTime, solarTermModel = 'legacy') {
...
function calculateCore(input, legacyAsOfYear, calendar) {
    ...
    const dayBoundary = input.dayBoundary ?? 'early-zi', solarTermModel = input.solarTermModel ?? 'legacy', normalizedInput = { ...input, asOfYear: asOfYear, dayBoundary, solarTermModel };
