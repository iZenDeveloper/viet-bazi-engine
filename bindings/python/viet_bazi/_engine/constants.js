...
const E = { Mộc: 'WOOD', Hỏa: 'FIRE', Thổ: 'EARTH', Kim: 'METAL', Thủy: 'WATER' };
const P = { Dương: 'YANG', Âm: 'YIN' };
const branchData = [
...
export const BRANCH_CODES = Object.fromEntries(BRANCHES.map(x => [x.name, x.code]));
export const ELEMENTS = ['Mộc', 'Hỏa', 'Thổ', 'Kim', 'Thủy'];
export const ELEMENT_CODES = E;
export const TEN_GOD_CODES = { 'Tỷ Kiên': 'BI_JIAN', 'Kiếp Tài': 'JIE_CAI', 'Thực Thần': 'SHI_SHEN', 'Thương Quan': 'SHANG_GUAN', 'Thiên Tài': 'PIAN_CAI', 'Chính Tài': 'ZHENG_CAI', 'Thất Sát': 'QI_SHA', 'Chính Quan': 'ZHENG_GUAN', 'Thiên Ấn': 'PIAN_YIN', 'Chính Ấn': 'ZHENG_YIN' };
